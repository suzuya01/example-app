@extends('layouts.app')
@section('content')
<div id="home" class="bg-slate-100 w-full pt-16 flex items-center">
    <div class="f-carousel w-full" id="myCarousel">
        ...
        <div class="f-carousel__track">
            <div class="f-carousel__slide bg-cover flex items-center" data-lazy-src="{{asset('storage/default/slider1.jpg')}}">
                <p class="uppercase font-bold text-white text-6xl my-auto leading-relaxed pl-32">Эко-продукция алтая <br>премиум качества</p>
            </div>
            <div class="f-carousel__slide bg-cover flex items-center" data-lazy-src="{{asset('storage/default/slider3.jpg')}}">
                <p class="uppercase font-bold text-white text-6xl my-auto leading-relaxed pl-32">Лучшее семейное <br>предприятие россии 2021</p>
            </div>
        </div>
        </div>
    </div>
...
<div id="about" class="w-full py-[70px]">
    ...
    <div class="py-20 text-center bg-slate-100">
        ...
        <p class="text-sm text-gray-500 mb-14">Используем лекарственные травы Алтая, натуральные масла, мёд и другие дары природы. Развиваем собственное производство в столице Алтайского края.</p>
        <div class=" container mx-auto w-[1200px] flex gap-14 justify-center mb-10 flex-wrap">
...
<div id="gallary" class="bg-slate-100 py-16">
    ...
    <div class="container mx-auto flex flex-wrap justify-center w-[1000px] mb-16 gap-10 z-0">
...
<div id="contact"class="bg-slate-100 p-10">
    <div class="container mx-auto w-[1200px] px-10 pb-16">
        ...
        <div class="flex justify-between items-center flex-wrap">
            <div class="">
                ...
                <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3A9d48d22aa50ce36e27dead86a917fa66562bdf56e409c0ab91c34f99c8b8f2c8&amp;source=constructor" width="545" height="400" frameborder="0"></iframe>
            </div>
            <div class="">
